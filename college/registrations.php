...
<html lang="en">
    ...
    <body>
        ...
        <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
            ...
            <div class="offcanvas-body">
                <div class="list-group text-break list-group-flush fs-4 text-center">
                    ...
                    <a class="list-group-item text-info list-group-item-action list-group-item-light p-3" href="registrations.php">Registrations</a>
        ...
        ?>
                ...
                <h4 class="my-5 text-center text-decoration-underline tug-1">View Registrations</h4>  
                    <div class="container">
                    <form action="approveregistration.php" id="approveregistrationform" method="post">
                        </form>
                     ...
                     <div class="table-responsive">
                         <table class="table table-bordered table-hover table-sm">
                             ...
                             <tbody>
                                 <?php
                                  $query = "select * from events_2022_registers";
                                 ...
                                 <tr class="align-middle text-nowrap text-center">
                                     ...
                                     <td>  
                                         ...
                                         {
                                         ?>
                                     <button type="submit" class="btn btn-sm shadow-none btn-info" name="approvebutton" form="approveregistrationform" value="<?=$row["id"]?>">
                                         Approve
                                         </button>
                                         <?php
                                         }
