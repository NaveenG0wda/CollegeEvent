...
<html lang="en">
    ...
    <body>
        ...
        <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
            ...
            <div class="offcanvas-body">
                <div class="list-group text-break list-group-flush fs-4 text-center">
                    ...
                    <a class="list-group-item text-info list-group-item-action list-group-item-light p-3" href="viewevents.php">View Events</a>
        ...
        ?>
                ...
                <h4 class="my-5 text-center text-decoration-underline tug-1">View Events</h4>  
                    <div class="container">
                         ...
                         <table class="table table-bordered table-hover table-sm">
                             ...
                             <tbody>
                                 ...
                                 <tr class="align-middle text-nowrap text-center">
                                     ...
                                     <td>
                                         <button type="submit" class="btn btn-sm shadow-none btn-danger" name="deletebutton" form="deleteeventform" value="<?=$row["id"]?>">
