    ...
    <body>
            ...
            <div class="d-flex flex-column min-vh-100">
                ...
                <nav class="navbar navbar-expand-lg py-3 navbar-dark bg-info border-bottom border-info">
                    <div class="container-fluid">
                        <button class="btn shadow-none btn-sm text-light" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions"><i class="bi bi-list fs-4"></i></button>
            ...
            <!-- <div class="border-end border-info bg-white" id="sidebar-wrapper">
                ...
                <a class="list-group-item list-group-item-action list-group-item-light p-3" href="dashboard.php">Dashboard</a>
                    <a class="list-group-item text-info list-group-item-action list-group-item-light p-3" href="applyevents.php">Apply Events</a>
        ...
        ?>
                ...
                <h4 class="my-5 text-center text-decoration-underline tug-1">Apply Events</h4>  
                    <div class="container">
                         ...
                         <table class="table table-bordered table-hover table-sm">
                             ...
                             <tbody>
                                 ...
                                 <tr class="align-middle text-nowrap text-center">
                                     ...
                                     <td>
                                        <a href="../student/<?=$row["link"]?>" class="btn btn-sm btn-success shadow-none" class="tug-1">Apply</a> 
                                     </td>
                                 </tr>
