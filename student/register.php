...
<body>
    <div class="d-flex flex-column min-vh-100 bg-image">
        ...
        <nav class="navbar shadow-sm navbar-expand-lg navbar-dark py-3 bg-info mb-5">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">STUDENT</a>
                <button class="btn btn-outline-info text-light shadow-none btn-sm py-1" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions">
        ...
        <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
            ...
            <div class="offcanvas-body">
                <div class="list-group text-break list-group-flush fs-4 text-center">
                    ...
                    <a class="list-group-item text-info list-group-item-action list-group-item-light p-3" href="register.php">Register</a>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card shadow-sm border-0">
                        ...
                        <div class="card-body">
                            <h3 class="fw-normal text-center mb-4 mt-3">REGISTER !</h3>
                            <form action="savestudent.php" method="post" id="loginform">
                                <div class="row justify-content-center gap-4">
                                    ...
                                    <div class="col-md-10">
                                        <div class="input-group position-relative">
                                            ...
                                            <input type="text" name="phone" id="phone" class="form-control shadow-none" placeholder="Phone">
                                ...
                                <div class="row justify-content-center mt-4">
                                    <div class="col-md-10 my-2">
                                        <button type="submit" name="savestudent" class="btn btn-sm fs-5 btn-outline-info shadow-none w-100">
                                            SUBMIT
                                        </button>
                                    </div>
                                </div>
