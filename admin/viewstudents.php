...
<html lang="en">
    <head>
        ...
        <title>View / Delete Students</title>
    ...
    <body>
        ...
        <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
            ...
            <div class="offcanvas-body">
                <div class="list-group text-break list-group-flush fs-4 text-center">
                    ...
                    <a class="list-group-item text-info list-group-item-action list-group-item-light p-3" href="viewstudents.php">View Students</a>
                ...
                <div id="liveToast" class="toast bg-success bg-opacity-75 hide" role="alert" aria-live="assertive" aria-atomic="true">
                    <div class="d-flex">
                        <div class="toast-body ms-auto text-white">
                            Student Deletetion Successfull !
                        </div>
        ...
        ?>
                ...
                <div class="container flex-fill">
                    <h4 class="my-5 text-center text-decoration-underline tug-1">View / Delete Students</h4>  
                    <div class="container">
                        <form action="deletestudent.php" id="deletestudentform" method="post"></form>
                     <div class="table-responsive">
                         <table class="table table-bordered table-hover table-sm">
                             ...
                             <tbody>
                                 <?php
                                  $query = "select * from events_2022_students";
                                 ...
                                 <tr class="align-middle text-nowrap text-center">
                                     ...
                                     <td>
                                         <button type="submit" class="btn btn-sm shadow-none btn-danger" name="deletebutton" form="deletestudentform" value="<?=$row["id"]?>">
